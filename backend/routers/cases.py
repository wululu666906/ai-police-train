...
def create_role(payload: dict = Body(...), db: Session = Depends(database.get_db)):
    ...
    db_role = models.Role(
        ...
        does_not_know="[]",
        hidden_truths="[]",
        persona_meta=_serialize_person_meta(_extract_person_meta(payload)),
    )
    db.add(db_role)
    db.flush()
...
def update_role(role_id: int, payload: dict = Body(...), db: Session = Depends(database.get_db)):
    ...
    db_role.interaction_style = ""
    db_role.personality = ""
    db_role.speaking_style = ""
    ...
    db_role.iq_level = ""
    db_role.eq_level = ""
    db_role.lying_ability = ""
    db_role.weakness = ""
    db_role.knows_facts = "[]"
    db_role.does_not_know = "[]"
    db_role.hidden_truths = "[]"
