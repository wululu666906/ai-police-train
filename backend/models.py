...
class Case(Base):
    ...
    case_type = Column(String(50)) # 纠纷/打架/盗窃
    background = Column(Text)
    created_at = Column(DateTime, default=datetime.utcnow)
    
    scenes = relationship("Scene", back_populates="cases")
...
class Scene(Base):
    ...
    roles = relationship("Role", back_populates="scene")
